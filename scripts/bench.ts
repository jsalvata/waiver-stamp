...
import { applyWaiver } from '../src/commands/apply.ts';
...
import { loadWaiverFromObject } from '../src/waiver/load.ts';
...
function renderMarkdown(s: {
  ...
  const rows = s.cells
    ...
    .join('\n');
  return [
    `<!-- generated by \`pnpm bench\` — ${s.model}, ${s.date}, mean ± stddev of ${s.runsPerCell} runs -->`,
    '',
