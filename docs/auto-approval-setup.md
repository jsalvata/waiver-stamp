...
The templates ship pinned to a release tag (`@v1.17.0`, kept current on every release), so **you
...
`gh api repos/jsalvata/waiver-stamp/commits/v1.17.0 --jq .sha`. You pin twice — the producer's
