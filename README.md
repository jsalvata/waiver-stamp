...
## Confining docs — `.waiver-stamp.json`
...
2. the project's **allow/deny policy** in `.waiver-stamp.json` at the repo root.
...
Both lists are gitignore-style globs and **empty by default** — with no config, or an
